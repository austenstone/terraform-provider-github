...
func TestNormalizeEtag(t *testing.T) {
	testCases := []struct {
		...
		{name: "empty etag", etag: "", want: ""},
		{name: "strong etag unchanged", etag: `"abc123"`, want: `"abc123"`},
		{name: "weak etag normalized", etag: `W/"abc123"`, want: `"abc123"`},
		{name: "weak etag with whitespace normalized", etag: "  W/\"abc123\"  ", want: `"abc123"`},
	}
